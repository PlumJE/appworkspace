// 지정한 패키지 내의 라이브러리를 사용하고자 할 떄 import
...
void main(List<String> arguments) {
  // print('Hello world: ${dart01_var.calculate()}!'); // 기존주석
  var numberA = 10; // 변수 선언 및 초기화, 타입 추론
  int numberB = 25; // 변수 선언 및 초기화, 타입 명시
  int result = add(numberA, numberB); // 함수 호출
  print(result); // 라인 단위로 출력 print(프린트)
  // lid 폴더 내 dart01_var.dar 안에 선언한 printResult() 함수를 호출
